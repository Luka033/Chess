...
from chess.constants import WHITE, W_ROOK, B_ROOK
...
class Rook(Piece):
    ...
    def __is_first_column_exclusion(self, current_position, candidate_offset):
        return piece_is_in_given_column(current_position, 0) and (candidate_offset == -1)

    def __is_eight_column_exclusion(self, current_position, candidate_offset):
        return piece_is_in_given_column(current_position, 7) and (candidate_offset == 1)